...
const verifyRefreshToken = async (refreshToken: string, context: IContextType) => {
    try {
        ...
        if (!foundUser) throw new Error('No user was found for refresh token');
