...
export class GroupByUserArgs {
  ...
  by!: Array<"id" | "email" | "firstName" | "lastName" | "userName" | "receivePromo" | "passwordHash" | "tokenVersion" | "birthday" | "phoneNumber" | "address" | "nationality" | "membershipExpiration" | "membershipType" | "avatar" | "accessToken">;
